    ...
    <div className="container grid items-center gap-1 py-4 h-screen md:h-[82vh] overflow-x-visible overflow-y-auto md:w-[50%] no-scrollbar">
      <div className="h-full flex flex-col gap-4">
        ...
        <Typography type="paragraph">
          ...
          services, features, or functionalities provided within the
          application. By accessing or using our application, you agree to
        ...
        <Typography type="paragraph">
          ...
          functional purposes only. You may use the application at your own
          risk, and we shall not be liable for any damages or harm that may
          arise from your use of the application. You are responsible for
          ensuring the security and confidentiality of your account credentials
          and any activities conducted through your account.
        </Typography>
        ...
        <Typography type="paragraph">
          ...
          not modify, reproduce, distribute, or create derivative works based on
        ...
        <Typography type="paragraph">
          ...
          the use of our application is at your own discretion and risk. We
        ...
        <Typography type="paragraph">
          ...
          time, with or without cause, and without prior notice or liability.
          Upon termination, all licenses and rights granted to you in these
        ...
        <Typography type="paragraph">
          ...
          continued use of the application after any modifications to these
