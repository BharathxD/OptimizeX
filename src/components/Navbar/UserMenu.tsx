  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          ref={menuRef}
          className="absolute mt-3 xl:mt-2 max-w-screen-sm rounded-xl shadow-md w-[40vw] md:w-min bg-zinc-800 overflow-hidden right-0 text-sm border-[1px] border-zinc-600"
        >
          {currentUser ? (
            <div>
              <MenuItem
