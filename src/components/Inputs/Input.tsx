    ...
    <Fragment>
      <div className="w-full relative">
        ...
        <input
          ...
          placeholder=" "
          type={type}
          className={`peer w-full p-4 pt-6 font-light bg-zinc-800 border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed shadow-sm focus:shadow-md
